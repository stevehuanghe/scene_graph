...
from backup.config import ModelConfig
from lib.pytorch_misc import optimistic_restore
from lib.evaluation.sg_eval import BasicSceneGraphEvaluator
from tqdm import tqdm
from backup.config import BOX_SCALE, IM_SCALE
import dill as pkl
import os
...
if conf.model == 'motifnet':
    ...
    from backup.rel_model_linknet import RelModelLinknet as RelModel
...
pred_embed = torch.Tensor(load_predicate_embeddings(GLOVE_VEC_FN, conf.rel_dim)).cuda()
